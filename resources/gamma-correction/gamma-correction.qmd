...
aliases:
  - "/OtherTopics/displays/displays.html"
description: "How to measure monitor gamma and apply it in visual experiments"
image: images/light-meter-on-screen.png
categories: [Behavioral, Displays]
author: NZ
...
-   Light meter device, like PCA-L335 (can be found in PTA's office). There are other similar devices available[^1].
    ...
    ![](images/pce-l335-light-meter.png)
...
![](images/light-meter-on-screen.png){width="260"}
...
![](images/light-meter-reading.png){width="245"}
...
![](images/luminance-readings-notes.png){width="246"}
...
-   open [`saveReadings.m`](https://github.com/visualneuroscience/visualneuroscience.github.io/blob/main/resources/gamma-correction/saveReadings.m) and edit the general info. If you want to customize the measurement, you may change the parameters as well.

-   run `saveReadings.m` (alternatively, you may call [`saveMonitorPhotometerReadings.m`](https://github.com/visualneuroscience/visualneuroscience.github.io/blob/main/resources/gamma-correction/saveMonitorPhotometerReadings.m) directly: `vals = saveMonitorPhotometerReadings(17, 'red')`)

-   then, call [`createGammaFromSavedReadings.m`](https://github.com/visualneuroscience/visualneuroscience.github.io/blob/main/resources/gamma-correction/createGammaFromSavedReadings.m) to create gamma tables
...
[Link to our GitHub repo containing relevant scripts](https://github.com/visualneuroscience/visualneuroscience.github.io/tree/main/resources/gamma-correction)

[Link to saved values and Gamma lookup tables for VPixx/3D](https://github.com/visualneuroscience/visualneuroscience.github.io/tree/main/resources/gamma-correction/luxMeasNewVPixx/)

[Link to saved values and Gamma lookup tables for MRI display devices](https://github.com/visualneuroscience/visualneuroscience.github.io/tree/main/resources/gamma-correction/luxMeasMRI/)
