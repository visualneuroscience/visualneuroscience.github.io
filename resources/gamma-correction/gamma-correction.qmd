...
code-links:
  - text: "Scripts on GitHub"
    icon: github
    href: https://github.com/visualneuroscience/visualneuroscience.github.io/tree/main/resources/gamma-correction
---
...
-   open [`saveReadings.m`](saveReadings.m){download="saveReadings.m"} and edit the general info. If you want to customize the measurement, you may change the parameters as well.

-   run `saveReadings.m` (alternatively, you may call [`saveMonitorPhotometerReadings.m`](saveMonitorPhotometerReadings.m){download="saveMonitorPhotometerReadings.m"} directly: `vals = saveMonitorPhotometerReadings(17, 'red')`)

-   then, call [`createGammaFromSavedReadings.m`](createGammaFromSavedReadings.m){download="createGammaFromSavedReadings.m"} to create gamma tables
