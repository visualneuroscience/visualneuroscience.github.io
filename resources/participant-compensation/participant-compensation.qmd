...
1.  Download the form available on the Institute's [sharepoint](https://sharepoint.uni-graz.at/sites/602/untersuchen/_layouts/15/WopiFrame2.aspx?sourcedoc=%7BFAA90B5A-5D5D-4DA2-A636-9FD2AE63A8D9%7D&file=Bestätigung_Untersuchung.pdf&action=default) and fill it out with your study's data (study name, your name, supervisor's name).
...
![](images/participation-confirmation-form.png)
...
1.  Download the example [excel sheet](https://github.com/visualneuroscience/visualneuroscience.github.io/tree/main/resources/participant-compensation/files/AWE_Form_example.xlsx)
...
If you did an MRI experiment you can provide your participants with a nifti file of their anatomical scan (prior to [defacing](../../mri/dicom-to-glm/04-defacing.qmd)). Please send the scans via the university email/ official university sharing tools to comply with data protection policies.

For viewing the scans, participants can use the browser-based nifti viewer [FreeBrowse](https://freesurfer.github.io/freebrowse/).

If the subject is technically savvy you can also share the instructions for creating surface models for 3D printing (see [3D printing a brain – Visual Neuroscience Lab](../../mri/3d-printing/3d-printing-a-brain.qmd)).
