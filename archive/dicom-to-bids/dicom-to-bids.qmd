...
aliases:
  - "/archive/dicom_to_bids.html"
description: "how to convert from dicom's to bids"
image: ./images/dicom2bids-start.png
categories: [MRI, BIDS, DICOM, Archived]
author: AC
date: 2024-08-12
---
...
See also [BIDS specification](https://bids-specification.readthedocs.io/en/stable/introduction.html)
...
![](./images/dicom2bids-dicomsearch-pybids.png)
...
![](./images/dicom2bids-renameinfo.png)
...
![](./images/dicom2bids-foldername-renameanat.png)
