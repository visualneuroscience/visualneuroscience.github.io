...
Notebook code that takes a long time to run can be run inside the NeurodeskTOP graphical interface. This time you can start the code and check on its execution status later, even from a different computer.
