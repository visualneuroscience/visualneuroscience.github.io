...
-   [ ] At the top level of your directory on storage, create a text/markdown file named "projects" containing server paths (/storage/, J:, or external storage in the case of Marilena) as follows
