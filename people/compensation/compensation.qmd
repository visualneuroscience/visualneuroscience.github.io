...
2.  Fill out one row per participant with the information they provided (you can create your own dedicated form for that). Ask Natalia for the correct value of the Innenauftrag field, since this varies from study to study. **Attention! The bank information should be 100% correct, otherwise there is an administrative disaster. Therefore, triple-check with participants.**
