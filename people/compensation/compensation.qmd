...
2.  Fill out one row per participant, entering information into EVERY field that is nonempty in the excel sheet (you can create your own dedicated template):
    ...
    -   BIC CPD: Participant's bank BIC-code. Note: Although it may seem meaningless, you need to get both IBAN and **BIC** from you subject (even if they try to convince you otherwise). This is important for the university.
