...
If you did an MRI experiment you can provide your participants with a nifti file of their anatomical scan (prior to [defacing](https://visualneuroscience.github.io/dicom_to_glm/defacing.html)). Please send the scans via the university email/ official university sharing tools to comply with data protection policies.
...
If the subject is technically savvy you can also share the instructions for creating surface models for 3D printing (see [3D printing a brain – Visual Neuroscience Lab](https://visualneuroscience.github.io/mri/3D-prints/3d-prints.html)).
