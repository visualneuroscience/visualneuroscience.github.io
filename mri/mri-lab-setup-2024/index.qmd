...
-   If the trigger box is not powered, plug it in
    ...
    ![Trigger box plugged in](images/clipboard-1147648555.png){width="300"}
...
-   On the right, the top light is constantly turned on if it is connected to the computer. On the bottom, the light is blinking whenever the scanner trigger is being sent
    ...
    ![](images/F841BB68-DDFC-4E3E-B6A6-E24FBB87B94C.JPG)

    If not, press the round button and select the following settings:

-   Manual config

    ![](images/9B0EEF03-CD1B-48AB-9D45-F936D7CE2390.JPG)

-   HHSC-2x4-L

    ![](images/C3F33E12-B1C5-45F1-A490-649C0B1B1335.JPG)

-   USB

    ![](images/A0755E6A-EB4A-47DB-9170-37CF7A50620A.JPG)

-   HID KEY 12345

    ![](images/86067ABB-CD86-4B15-A49B-128F5A51069D-01.JPG)
