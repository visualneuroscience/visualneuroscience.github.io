...
aliases:
  - "/mri/oriented-bounding-box/calculating_oriented_bounding_box.html"
description: "How to use 3D Slicer to calculate oriented bounding box"
image: ./images/3d-slicer.png
...
![Click "Add Data"](./images/importing-data1.png)
...
![](./images/import-as-segmentation.png)
...
![](./images/segment-stats-menu.png)

</center>

- In the Inputs field ensure that the segmentation you want the statistics on is selected

- To add more stats click on the options next to "Labelmap Statistics"
...
::: {layout-ncol=2}
![In the data tab you should see Table, oriented bounding box markup and screenshots (axial, coronal, sagittal)](./images/list-of-data.png)

![Choose directory where to save data and click check box on what to save](./images/save-data.png)
:::
