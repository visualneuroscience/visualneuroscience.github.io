...
![](./images/puls-and-resp-files.jpg)
...
![](./images/respiratory-signal-artifacts.jpg)

**Figure 3.** Final output (RETROICOR regressors)

![](./images/retroicor-regressors.png)

**Figure 4.** Steps from raw data to the final regressors.

![](./images/physio-processing-steps.jpg)
