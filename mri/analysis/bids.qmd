...
Upload your dataset to OSF using *osfclient* (user's guide [here](https://osfclient.readthedocs.io/en/latest/cli-usage.html)). This is a useful python-based package to uploading data in bulk to OSF, especially because you cannot upload folders to OSF projects via browser.
