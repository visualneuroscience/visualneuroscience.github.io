...
- The files might need to be *unzipped* first. This is becuase the script uses SPM12 and that this is only able to read files that end in `.nii` and not `.nii.gz`
