...
aliases:
  - "/mri/analysis/bids.html"
description: Information about BIDS and OSF
image: ../../images/thumbnails/bids-and-osf.svg
categories: [BIDS, OSF]
author: AA
date: 2024-05-23
---
...
Brain Imaging Data Structure (more information in the [BIDS starter kit](https://bids-standard.github.io/bids-starter-kit/)).
...
-   files don't follow BIDS naming conventions (more info about [BIDS file naming](https://bids-standard.github.io/bids-starter-kit/folders_and_files/files.html))
...
-   dataset_description is missing or there is no name of the dataset or author names in it.
-   readme file is missing or too short
-   ...

# OSF

Upload your dataset to OSF using *osfclient* ([user's guide](https://osfclient.readthedocs.io/en/latest/cli-usage.html)). This is a useful python-based package to uploading data in bulk to OSF, especially because you cannot upload folders to OSF projects via browser.
