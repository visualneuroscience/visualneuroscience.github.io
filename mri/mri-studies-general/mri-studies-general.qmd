...
- These files can be generated on the fly by the [psychopy BIDS plugin](https://psychopy-bids.readthedocs.io/en/stable/) or creted post-hoc from
...
- MRI safety and data protection form of the MRI lab (can be found [here](https://mri-lab.uni-graz.at/de/forscherinnen/downloads/) in your favorite langauge). This form is the same for all fMRI studies. It stays with RTAs in the MRI lab.
