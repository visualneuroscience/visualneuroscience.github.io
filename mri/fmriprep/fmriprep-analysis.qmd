...
-   fMRIprep follows the BIDS format, see [how to validate BIDS](../bids-and-osf/bids-and-osf.qmd)
...
[NOTE: using `fitlins` does not currently work using the flag `-u $(id -u):$(id -g)` the user must specify their user id directly e.g. `-u 1087:1092` see post about fitlins]{.small}
...
::: {.callout-note collapse="true" appearance="simple" title="Show script"}
