...
``` {.bash .copy-code}
fmriprep /home/jovyan/website/bids \
  /home/jovyan/website/bids/derivatives/fmriprep participant \
  --bold2t1w-init header --force-bbr \
  -w /home/jovyan/website/fmriprep_tmp \
  --output-spaces T1w fsaverage fsnative \
  --participant-label sub-999 \
  --nprocs 8 --mem 10000 \
  --skip_bids_validation --stop-on-first-crash -v \
  --fs-license-file /home/jovyan/website/freesurferlicense/license.txt
```
...
``` {.bash .copy-code filename="run_fmriprep.sh"}
