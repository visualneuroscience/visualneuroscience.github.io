...
aliases:
  - "/dicom_to_glm/roi_analysis.html"
description: "Example of ROI Analysis"
image: ../../images/thumbnails/09-roi-analysis.svg
...
Similar to the [first level GLM](./08-first-level-glm.qmd), an example is provided and described as a starting point to adapt your own work.
...
2.  Define important variables and constants:
    ...
    -   subregions: contrasts from the [first level GLM](./08-first-level-glm.qmd) data of the functional localizer.
    -   contrast_names: contrasts from the [first level GLM](./08-first-level-glm.qmd) data of the main experiment
    -   tasks (optional): you don´t need to include this, but you might need to change subsequent code then

3.  Define an initial mask based on the [retinotopy data](./07-retinotopic-mapping.qmd) (for every subject individually):
