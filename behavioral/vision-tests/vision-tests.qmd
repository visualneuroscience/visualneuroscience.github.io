...
title: Vision tests
aliases:
  - "/behavioral/2024-05-22/index.html"
description: "How to conduct vision tests"
image: ../../images/thumbnails/vision-tests.svg
author: CY
...
**FrACT10:** Test when both eyes are open and then, when only one eye open (left and right separately). You may train the subject before testing because it is not so straight-forward for some people.
