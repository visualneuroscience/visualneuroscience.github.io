...
-   Preprocess data from a subject with [`createBIDS_beh_after_preprocessing.m`](https://github.com/visualneuroscience/visualneuroscience.github.io/blob/main/behavioral/bids-behavioral/createBIDS_beh_after_preprocessing.m) (it needs [`getBIDSdirectory.m`](https://github.com/visualneuroscience/visualneuroscience.github.io/blob/main/behavioral/bids-behavioral/getBIDSdirectory.m) on the MATLAB path):

`createBIDS_beh_after_preprocessing(root_dir, ‘transriv’, ‘S001’, ‘Rivalry’, ‘GG’)`

-   Create dataset files by running [`transriv_finalizeBIDS.m`](https://github.com/visualneuroscience/visualneuroscience.github.io/blob/main/behavioral/bids-behavioral/transriv_finalizeBIDS.m) (when data collection is finished)
