...
In this step, you will compute beta-estimates for predefined contrasts for each subject individually. These estimations will often be used later in the [second level Analysis](second_level_glm_nilearn.qmd) to compute your "actual" statistical analysis (t-Tests, ANOVA,...).
...
If you used one task and have multiple Sessions, you can adapt this script: `/shared/nilearn_ffx.ipynb`
