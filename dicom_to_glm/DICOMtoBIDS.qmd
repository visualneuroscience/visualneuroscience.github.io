...
![DICOM-Files](./images/01_dcm2bids/001_1_DICOMS.png)
...
As a last preparation step, you are asked, if you would like to change the session folder from `ses-1` to another session. If you only have one session, type `n` and press `enter`![Keep Ses-1](./images/01_dcm2bids/12_SelectSession.png)
...
Subsequently, you get a short reminder in which directories your files should be stored to get a BIDS-conform structure.![Reminder before Start](./images/01_dcm2bids/13_Start.png)
