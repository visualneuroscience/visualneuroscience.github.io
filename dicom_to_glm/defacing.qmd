...
When we acquired data "ourselves", we definitely have to deface the T1w-scan ([after converting the DICOMs to niftis](DICOMtoBIDS.qmd)) before we can continue!
...
3.  Click on `pydeface 2.0.2` ![Pydeface 2.0.2](./images/03_Defacing/01_open_Pydeface.png)
...
and it should look like this: ![Pydeface Command](./images/03_Defacing/04_pydeface_command.png)

Press enter to start the process. Again, it might take a few moments until pydeface finishes, be patient!

At the end, it should look like this: ![Pydeface Finished](./images/03_Defacing/05_defacing_finished.png)
