...
::: callout-warning
Depending on the version of [fMRIprep](run_fmriprep.qmd) you plan to use for preprocessing, you need different naming conventions of the entries!!!!
:::
...
::: callout-hint
Due to these differences and potential resulting problems (e.g. no distortion correction is applied), you should always check the content of the fmap's "IntendedFor" field before [running fMRIprep](run_fmriprep.qmd). If distortion correction is not applied, the IntendedFor field of the fmap´s `.json` file is generally the first approach to solve the problem!
:::
