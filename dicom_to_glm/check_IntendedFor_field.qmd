...
There is a dedicated script to update the contents of the fmap's .json file. It can be found at `/shared/update_json.py`. Of course, you can do the changes manually as well.
